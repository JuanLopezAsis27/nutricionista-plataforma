 ...
 * pacientes.
 *
 * Los campos fijos son el mínimo común; acá se declara lo que sigue este
...
export function GestionCamposHistoriaClinica() {
  ...
  return (
    <GestionCamposPersonalizados
      ...
      vacio="Todavía no agregaste campos propios. La historia clínica muestra solo sus campos fijos."
