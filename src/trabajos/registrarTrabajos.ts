...
import { registrarLimpiarSesionesCaducadas } from "./manejadores/limpiarSesionesCaducadas";
 ...
 * Las limpiezas (bucket y sesiones caducadas) son transversales y siguen siendo
 * trabajos únicos.
 *
...
export async function registrarTrabajos(boss: PgBoss): Promise<void> {
  ...
  await registrarLimpiarSesionesCaducadas(boss);
}
