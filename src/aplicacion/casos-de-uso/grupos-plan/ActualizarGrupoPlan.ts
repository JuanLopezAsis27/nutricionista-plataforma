...
import type { GrupoPlan, DatosGrupoPlan } from "@/dominio/entidades/GrupoPlan";
import { ErrorGrupoPlanNoEncontrado } from "@/dominio/errores/ErrorGrupoPlanNoEncontrado";
