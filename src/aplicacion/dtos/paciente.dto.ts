...
export const crearPacienteDesdeFichaDto = crearPacienteConAccesoDto.extend({
  historiaClinica: z
    .object({
      ...
      alergiasIntolerancias: z.string().max(5000).nullable(),
      antecedentesDigestivos: z.string().max(5000).nullable(),
      antecedentesFamiliares: z.string().max(5000).nullable(),
      entrenamientos: z.string().max(5000).nullable(),
      descanso: z.string().max(5000).nullable(),
      habitos: z.string().max(5000).nullable(),
      informacionGeneral: z.string().max(5000).nullable(),
