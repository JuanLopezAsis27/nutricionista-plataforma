...
export const enlacesTurno = perezoso(
  () => new FirmaEnlacesTurno(process.env.AUTH_SECRET, urlPublica()),
);
...
export const repositorioPlanSemanal = perezoso(
  () => new PrismaRepositorioPlanSemanal(prisma()),
);
