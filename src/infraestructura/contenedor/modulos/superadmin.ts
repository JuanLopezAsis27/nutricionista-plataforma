...
import { CrearCuentaNutricionista } from "@/dominio/casos-de-uso/superadmin/CrearCuentaNutricionista";
import { ListarNutricionistas } from "@/dominio/casos-de-uso/superadmin/ListarNutricionistas";
import { CambiarEstadoNutricionista } from "@/dominio/casos-de-uso/superadmin/CambiarEstadoNutricionista";
...
export function crearServicioSuperAdmin(deps: {
  ...
  return new ServicioSuperAdmin(
    new CrearCuentaNutricionista(deps.usuarios, deps.hasheador, deps.provisionador),
